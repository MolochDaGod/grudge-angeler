...
const FISH_TYPES: FishDef[] = [
  ...
  { name: "Phantom Minnow", icon: "/assets/icons/fish/phantom-minnow-spectral-ultra_rare.png", catchAsset: "/assets/catch/phantom-minnow-spectral-ultra_rare.png", creatureFolder: "phantom-minnow-spectral-ultra_rare", idleFrames: 4, walkFrames: 4, points: 500, rarity: "ultra_rare", weight: 0.3, minDepth: 0.55, speed: 2.2, description: "A ghostly minnow wreathed in spectral flame.", baseScale: 1.8 },
  ...
  { name: "Storm Swordfish", icon: "/assets/icons/fish/storm-swordfish-electric-ultra_rare.png", catchAsset: "/assets/catch/storm-swordfish-electric-ultra_rare.png", creatureFolder: "storm-swordfish-electric-ultra_rare", idleFrames: 4, walkFrames: 4, points: 1000, rarity: "ultra_rare", weight: 0.12, minDepth: 0.7, speed: 2.5, description: "A swordfish that rides lightning bolts.", baseScale: 2.0 },
  { name: "Celestial Whale", icon: "/assets/icons/fish/celestial-whale-cosmic-ultra_rare.png", catchAsset: "/assets/catch/celestial-whale-cosmic-ultra_rare.png", creatureFolder: "celestial-whale-cosmic-ultra_rare", idleFrames: 4, walkFrames: 4, points: 2000, rarity: "ultra_rare", weight: 0.05, minDepth: 0.75, speed: 0.4, description: "A cosmic whale that swallowed a dying star.", baseScale: 2.5 },
  ...
  { name: "Shadow Leviathan", icon: "/assets/icons/fish/shadow-leviathan-shadow-ultra_rare.png", catchAsset: "/assets/catch/shadow-leviathan-shadow-ultra_rare.png", creatureFolder: "shadow-leviathan-shadow-ultra_rare", idleFrames: 4, walkFrames: 4, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss.", tint: "rgba(140,15,15,0.5)", baseScale: 2.5 },
