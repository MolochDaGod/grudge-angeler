...
const FISH_TYPES: FishDef[] = [
  { name: "Minnow", icon: "/assets/icons/fish/minnow-silver-common.png", catchAsset: "/assets/catch/minnow-silver-common.png", creatureFolder: "minnow-silver-common", idleFrames: 2, walkFrames: 2, points: 10, rarity: "common", weight: 40, minDepth: 0.15, speed: 1.5, description: "A tiny silver fish, common in shallow waters.", tint: "rgba(200,210,230,0.2)", baseScale: 0.6 },
  ...
  { name: "Perch", icon: "/assets/icons/fish/perch-striped-common.png", catchAsset: "/assets/catch/perch-striped-common.png", creatureFolder: "perch-striped-common", idleFrames: 2, walkFrames: 2, points: 25, rarity: "common", weight: 30, minDepth: 0.25, speed: 1.2, description: "A striped freshwater fish with sharp fins." },
  ...
  { name: "Swordfish", icon: "/assets/icons/fish/swordfish-blue-rare.png", catchAsset: "/assets/catch/swordfish-blue-rare.png", creatureFolder: "swordfish-blue-rare", idleFrames: 2, walkFrames: 2, points: 150, rarity: "rare", weight: 4, minDepth: 0.55, speed: 1.8, description: "A powerful ocean predator with a sharp bill." },
  { name: "Stingray", icon: "/assets/icons/fish/stingray-gray-rare.png", catchAsset: "/assets/catch/stingray-gray-rare.png", creatureFolder: "stingray-gray-rare", idleFrames: 2, walkFrames: 2, points: 100, rarity: "rare", weight: 5, minDepth: 0.45, speed: 1.4, description: "A flat-bodied ray gliding silently along the ocean floor.", tint: "rgba(100,110,130,0.25)", baseScale: 1.2 },
  { name: "Whale", icon: "/assets/icons/fish/whale-blue-legendary.png", catchAsset: "/assets/catch/whale-blue-legendary.png", creatureFolder: "whale-blue-legendary", idleFrames: 2, walkFrames: 2, points: 300, rarity: "legendary", weight: 1, minDepth: 0.65, speed: 0.5, description: "The king of the deep. Incredibly rare!", tint: "rgba(40,80,180,0.45)", baseScale: 1.8 },
  ...
  { name: "Anglerfish", icon: "/assets/icons/fish/anglerfish-dark-rare.png", catchAsset: "/assets/catch/anglerfish-dark-rare.png", creatureFolder: "anglerfish-dark-rare", idleFrames: 2, walkFrames: 2, points: 120, rarity: "rare", weight: 5, minDepth: 0.55, speed: 0.6, description: "A deep-sea predator with a bioluminescent lure." },
  { name: "Deep Sea Angler", icon: "/assets/icons/fish/deep-sea-angler-dark-rare.png", catchAsset: "/assets/catch/deep-sea-angler-dark-rare.png", creatureFolder: "deep-sea-angler-dark-rare", idleFrames: 2, walkFrames: 2, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow." },
  { name: "Phantom Minnow", icon: "/assets/icons/fish/phantom-minnow-spectral-ultra_rare.png", catchAsset: "/assets/catch/phantom-minnow-spectral-ultra_rare.png", creatureFolder: "phantom-minnow-spectral-ultra_rare", idleFrames: 2, walkFrames: 2, points: 500, rarity: "ultra_rare", weight: 0.3, minDepth: 0.55, speed: 2.2, description: "A ghostly minnow wreathed in spectral flame.", baseScale: 1.8 },
  { name: "Volcanic Perch", icon: "/assets/icons/fish/volcanic-perch-molten-ultra_rare.png", catchAsset: "/assets/catch/volcanic-perch-molten-ultra_rare.png", creatureFolder: "volcanic-perch-molten-ultra_rare", idleFrames: 4, walkFrames: 4, points: 600, rarity: "ultra_rare", weight: 0.25, minDepth: 0.6, speed: 1.6, description: "A perch superheated by deep-sea vents.", baseScale: 2.0 },
  { name: "Abyssal Bass", icon: "/assets/icons/fish/abyssal-bass-dark-ultra_rare.png", catchAsset: "/assets/catch/abyssal-bass-dark-ultra_rare.png", creatureFolder: "abyssal-bass-dark-ultra_rare", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches.", baseScale: 2.2 },
  { name: "Frost Catfish", icon: "/assets/icons/fish/frost-catfish-ice-ultra_rare.png", catchAsset: "/assets/catch/frost-catfish-ice-ultra_rare.png", creatureFolder: "frost-catfish-ice-ultra_rare", idleFrames: 4, walkFrames: 4, points: 800, rarity: "ultra_rare", weight: 0.18, minDepth: 0.6, speed: 0.9, description: "An ancient catfish encased in living ice.", baseScale: 2.3 },
  { name: "Storm Swordfish", icon: "/assets/icons/fish/storm-swordfish-electric-ultra_rare.png", catchAsset: "/assets/catch/storm-swordfish-electric-ultra_rare.png", creatureFolder: "storm-swordfish-electric-ultra_rare", idleFrames: 2, walkFrames: 2, points: 1000, rarity: "ultra_rare", weight: 0.12, minDepth: 0.7, speed: 2.5, description: "A swordfish that rides lightning bolts.", baseScale: 2.0 },
  { name: "Celestial Whale", icon: "/assets/icons/fish/celestial-whale-cosmic-ultra_rare.png", catchAsset: "/assets/catch/celestial-whale-cosmic-ultra_rare.png", creatureFolder: "celestial-whale-cosmic-ultra_rare", idleFrames: 2, walkFrames: 2, points: 2000, rarity: "ultra_rare", weight: 0.05, minDepth: 0.75, speed: 0.4, description: "A cosmic whale that swallowed a dying star.", baseScale: 2.5 },
  ...
  { name: "Shadow Leviathan", icon: "/assets/icons/fish/shadow-leviathan-shadow-ultra_rare.png", catchAsset: "/assets/catch/shadow-leviathan-shadow-ultra_rare.png", creatureFolder: "shadow-leviathan-shadow-ultra_rare", idleFrames: 2, walkFrames: 2, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss.", tint: "rgba(140,15,15,0.5)", baseScale: 2.5 },
  { name: "The Seal at the Seam", icon: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", catchAsset: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", creatureFolder: "seal-at-the-seam-cosmic-ultra_rare", idleFrames: 6, walkFrames: 6, points: 5000, rarity: "ultra_rare", weight: 0.02, minDepth: 0.9, speed: 0.3, description: "A living sigil at the boundary of reality.", tint: "rgba(20,40,120,0.5)", baseScale: 2.8 },
];
