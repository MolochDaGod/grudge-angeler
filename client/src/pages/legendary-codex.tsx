...
function CodexAnimatedSprite({ sprite, size, wiggleId }: { sprite: SpriteData; size: number; wiggleId?: number }) {
  const [frame, setFrame] = useState(1);
  const animName = `fishWiggle${wiggleId ?? 0}`;
  const duration = 2.5 + (wiggleId ?? 0) * 0.3;
  ...
  const wiggleStyle: React.CSSProperties = {
  ...
  if (sprite.isSingleImage) {
    return (
      <div style={{ width: size, height: size, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", flexShrink: 0 }}>
        <style>{`
          @keyframes ${animName} {
            0%, 100% { transform: rotate(0deg) scaleX(1) translateY(0px); }
            15% { transform: rotate(1.5deg) scaleX(0.98) translateY(-1px); }
            30% { transform: rotate(-1deg) scaleX(1.01) translateY(1px); }
            50% { transform: rotate(1deg) scaleX(0.99) translateY(-2px); }
            70% { transform: rotate(-1.5deg) scaleX(1.01) translateY(0px); }
            85% { transform: rotate(0.5deg) scaleX(0.99) translateY(1px); }
          }
        `}</style>
        <img src={sprite.src} alt="" style={{ width: size, height: size, imageRendering: "pixelated", objectFit: "contain", ...wiggleStyle }} />
      </div>
    );
  }
  ...
  return (
    <div style={{ width: size, height: size, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      <style>{`
        @keyframes ${animName} {
          0%, 100% { transform: rotate(0deg) scaleX(1) translateY(0px); }
          15% { transform: rotate(2deg) scaleX(0.97) translateY(-2px); }
          30% { transform: rotate(-1.5deg) scaleX(1.02) translateY(1px); }
          50% { transform: rotate(1.5deg) scaleX(0.98) translateY(-3px); }
          70% { transform: rotate(-2deg) scaleX(1.01) translateY(0px); }
          85% { transform: rotate(0.8deg) scaleX(0.99) translateY(2px); }
        }
      `}</style>
      <img
...
const legendaries = [
  {
    ...
    artImage: "/assets/fish-images/phantom-minnow.png",
    stars: 5,
    pts: 500,
    wt: "0.3%",
    spd: 2.2,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/volcanic-perch.png",
    stars: 5,
    pts: 600,
    wt: "0.25%",
    spd: 1.6,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/abyssal-bass.png",
    stars: 5,
    pts: 750,
    wt: "0.2%",
    spd: 1.4,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/frost-catfish.png",
    stars: 5,
    pts: 800,
    wt: "0.18%",
    spd: 0.9,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/storm-swordfish.png",
    stars: 5,
    pts: 1000,
    wt: "0.12%",
    spd: 2.5,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/celestial-whale.png",
    stars: 5,
    pts: 2000,
    wt: "0.05%",
    spd: 0.4,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/neon-eel.png",
    stars: 5,
    pts: 650,
    wt: "0.22%",
    spd: 1.9,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/golden-salmon.png",
    stars: 5,
    pts: 700,
    wt: "0.2%",
    spd: 1.5,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/shadow-leviathan.png",
    stars: 5,
    pts: 1500,
    wt: "0.08%",
    spd: 0.6,
  ...
  },
  {
    ...
    artImage: "/assets/fish-images/seal-at-the-seam.png",
    stars: 5,
    pts: 5000,
    wt: "0.01%",
    spd: 0.1,
