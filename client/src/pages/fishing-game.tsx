...
export default function FishingGame() {
  ...
  useEffect(() => {
    ...
    const assets = [
      ...
      "/assets/fish-images/shark.png",
      "/assets/fish-images/kraken.png",
      "/assets/fish-images/sea-devil.png",
        ...
        if (pred.state === "death") {
          ...
          if (pred.attackCooldown <= 0 && s.gameState === "waiting") {
            ...
            if (dist < 80 && Math.random() < 0.005 * dt) {
              ...
              s.biteTimer = (120 + Math.random() * 80) * vitBonus;
              s.exclamationTimer = 0;
              const predIconMap: Record<string, string> = { "Shark": "/assets/fish-images/shark.png", "Kraken": "/assets/fish-images/kraken.png", "Sea Devil": "/assets/fish-images/sea-devil.png", "Shadow Leviathan": "/assets/predators/leviathan/Idle.png" };
              s.currentCatch = { 
