...
const FISH_TYPES: FishType[] = [
  { name: "Minnow", icon: "/assets/icons/fish/minnow-silver-common.png", catchAsset: "/assets/catch/minnow-silver-common.png", catchW: 45, catchH: 42, creatureFolder: "minnow-silver-common", idleFrames: 4, walkFrames: 6, points: 10, rarity: "common", weight: 40, minDepth: 0.15, speed: 1.5, description: "A tiny silver fish, common in shallow waters.", tint: "rgba(200,210,230,0.2)", baseScale: 0.6 },
  ...
  { name: "Perch", icon: "/assets/icons/fish/perch-striped-common.png", catchAsset: "/assets/catch/perch-striped-common.png", catchW: 45, catchH: 42, creatureFolder: "perch-striped-common", idleFrames: 4, walkFrames: 6, points: 25, rarity: "common", weight: 30, minDepth: 0.25, speed: 1.2, description: "A striped freshwater fish with sharp fins." },
  { name: "Bass", icon: "/assets/icons/fish/bass-green-uncommon.png", catchAsset: "/assets/catch/bass-green-uncommon.png", catchW: 27, catchH: 39, creatureFolder: "bass-green-uncommon", idleFrames: 4, walkFrames: 6, points: 50, rarity: "uncommon", weight: 15, minDepth: 0.35, speed: 1.0, description: "A strong fighter popular with anglers.", tint: "rgba(60,80,40,0.3)" },
  ...
  { name: "Octopus", icon: "/assets/icons/fish/octopus-red-common.png", catchAsset: "/assets/catch/octopus-red-common.png", catchW: 35, catchH: 32, creatureFolder: "octopus-red-common", idleFrames: 4, walkFrames: 6, points: 35, rarity: "common", weight: 15, minDepth: 0.25, speed: 0.9, description: "A clever red octopus with grasping tentacles." },
  { name: "Salmon", icon: "/assets/icons/fish/salmon-pink-uncommon.png", catchAsset: "/assets/catch/salmon-pink-uncommon.png", catchW: 45, catchH: 42, creatureFolder: "salmon-pink-uncommon", idleFrames: 4, walkFrames: 6, points: 60, rarity: "uncommon", weight: 12, minDepth: 0.35, speed: 1.1, description: "A prized pink-fleshed fish.", tint: "rgba(220,100,80,0.4)" },
  ...
  { name: "Blue Ring Octopus", icon: "/assets/icons/fish/blue-ring-octopus-blue-uncommon.png", catchAsset: "/assets/catch/blue-ring-octopus-blue-uncommon.png", catchW: 35, catchH: 32, creatureFolder: "blue-ring-octopus-blue-uncommon", idleFrames: 4, walkFrames: 6, points: 55, rarity: "uncommon", weight: 8, minDepth: 0.35, speed: 1.0, description: "A small but deadly octopus with glowing blue rings." },
