...
const BEACH_CRABS: FishType[] = [
  { name: "Red Crab", icon: "/assets/icons/fish/red-crab-red-common.png", catchAsset: "/assets/icons/fish/red-crab-red-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 8, rarity: "common", weight: 50, minDepth: 0.05, speed: 0.9, description: "A small red crab that scuttles along the beach.", beachCrab: true, spriteSheet: "/assets/crabs/red-crab-red-common.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Blue Crab", icon: "/assets/icons/fish/blue-crab-blue-common.png", catchAsset: "/assets/icons/fish/blue-crab-blue-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 10, rarity: "common", weight: 40, minDepth: 0.05, speed: 1.0, description: "A bright blue crab found near tidal pools.", beachCrab: true, spriteSheet: "/assets/crabs/blue-crab-blue-common.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Green Crab", icon: "/assets/icons/fish/green-crab-green-common.png", catchAsset: "/assets/icons/fish/green-crab-green-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 8, rarity: "common", weight: 45, minDepth: 0.05, speed: 0.8, description: "A mossy green crab hiding in the seaweed.", beachCrab: true, spriteSheet: "/assets/crabs/green-crab-green-common.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Purple Crab", icon: "/assets/icons/fish/purple-crab-purple-uncommon.png", catchAsset: "/assets/icons/fish/purple-crab-purple-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 15, rarity: "uncommon", weight: 20, minDepth: 0.05, speed: 1.1, description: "An uncommon purple crab with iridescent shell.", beachCrab: true, spriteSheet: "/assets/crabs/purple-crab-purple-uncommon.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Gold Crab", icon: "/assets/icons/fish/gold-crab-gold-uncommon.png", catchAsset: "/assets/icons/fish/gold-crab-gold-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 25, rarity: "uncommon", weight: 15, minDepth: 0.05, speed: 1.2, description: "A rare golden crab. Prized for its shimmering shell.", beachCrab: true, spriteSheet: "/assets/crabs/gold-crab-gold-uncommon.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Cyan Crab", icon: "/assets/icons/fish/cyan-crab-cyan-common.png", catchAsset: "/assets/icons/fish/cyan-crab-cyan-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 8, rarity: "common", weight: 45, minDepth: 0.05, speed: 0.85, description: "A pale cyan crab commonly found on sandy shores.", beachCrab: true, spriteSheet: "/assets/crabs/cyan-crab-cyan-common.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Pink Crab", icon: "/assets/icons/fish/pink-crab-pink-common.png", catchAsset: "/assets/icons/fish/pink-crab-pink-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 12, rarity: "common", weight: 35, minDepth: 0.05, speed: 0.95, description: "A cute pink crab that loves warm shallow waters.", beachCrab: true, spriteSheet: "/assets/crabs/pink-crab-pink-common.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Dark Crab", icon: "/assets/icons/fish/dark-crab-dark-uncommon.png", catchAsset: "/assets/icons/fish/dark-crab-dark-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 20, rarity: "uncommon", weight: 18, minDepth: 0.05, speed: 1.15, description: "A dark-shelled crab with powerful pincers.", beachCrab: true, spriteSheet: "/assets/crabs/dark-crab-dark-uncommon.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Crimson Crab", icon: "/assets/icons/fish/crimson-crab-crimson-rare.png", catchAsset: "/assets/icons/fish/crimson-crab-crimson-rare.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 40, rarity: "rare", weight: 8, minDepth: 0.05, speed: 1.4, description: "A blood-red crab with Sea Devil markings. Extremely aggressive.", beachCrab: true, spriteSheet: "/assets/crabs/crimson-crab-crimson-rare.png", spriteRow: 0, spriteFrameSize: 1024 },
  { name: "Shadow Crab", icon: "/assets/icons/fish/shadow-crab-shadow-rare.png", catchAsset: "/assets/icons/fish/shadow-crab-shadow-rare.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 1, points: 55, rarity: "rare", weight: 5, minDepth: 0.05, speed: 1.6, description: "A dark maroon crab that moves like a phantom. Kin of the Sea Devil.", beachCrab: true, spriteSheet: "/assets/crabs/shadow-crab-shadow-rare.png", spriteRow: 0, spriteFrameSize: 1024 },
];
