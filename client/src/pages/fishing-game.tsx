...
const FISH_TYPES: FishType[] = [
  { name: "Minnow", icon: "/assets/icons/fish/minnow-silver-common.png", catchAsset: "/assets/catch/minnow-silver-common.png", catchW: 92, catchH: 22, creatureFolder: "minnow-silver-common", idleFrames: 2, walkFrames: 2, points: 10, rarity: "common", weight: 40, minDepth: 0.15, speed: 1.5, description: "A tiny silver fish, common in shallow waters.", tint: "rgba(200,210,230,0.2)", baseScale: 0.15 },
  ...
  { name: "Bass", icon: "/assets/icons/fish/bass-green-uncommon.png", catchAsset: "/assets/catch/bass-green-uncommon.png", catchW: 36, catchH: 34, creatureFolder: "bass-green-uncommon", idleFrames: 1, walkFrames: 2, points: 50, rarity: "uncommon", weight: 15, minDepth: 0.35, speed: 1.0, description: "A strong fighter popular with anglers.", baseScale: 0.055 },
  { name: "Catfish", icon: "/assets/icons/fish/catfish-brown-uncommon.png", catchAsset: "/assets/catch/catfish-brown-uncommon.png", catchW: 56, catchH: 36, creatureFolder: "catfish-brown-uncommon", idleFrames: 4, walkFrames: 4, points: 75, rarity: "uncommon", weight: 8, minDepth: 0.15, speed: 0.8, description: "A bottom-dweller with long whiskers.", tint: "rgba(160,120,80,0.15)", staticImg: "/assets/catch/catfish-brown-uncommon.png", bottomDweller: true, baseScale: 0.5 },
  ...
  { name: "Stingray", icon: "/assets/icons/fish/stingray-gray-rare.png", catchAsset: "/assets/catch/stingray-gray-rare.png", catchW: 92, catchH: 22, creatureFolder: "stingray-gray-rare", idleFrames: 2, walkFrames: 2, points: 100, rarity: "rare", weight: 5, minDepth: 0.45, speed: 1.4, description: "A flat-bodied ray gliding silently along the ocean floor.", tint: "rgba(100,110,130,0.25)", baseScale: 0.8 },
  ...
  { name: "Eel", icon: "/assets/icons/fish/eel-dark-common.png", catchAsset: "/assets/catch/eel-dark-common.png", catchW: 36, catchH: 11, creatureFolder: "eel-dark-common", idleFrames: 4, walkFrames: 6, points: 40, rarity: "common", weight: 20, minDepth: 0.3, speed: 1.3, description: "A slippery serpentine fish.", tint: "rgba(50,60,70,0.15)", baseScale: 0.4 },
  { name: "Octopus", icon: "/assets/icons/fish/octopus-red-common.png", catchAsset: "/assets/catch/octopus-red-common.png", catchW: 35, catchH: 32, creatureFolder: "octopus-red-common", idleFrames: 6, walkFrames: 6, points: 35, rarity: "common", weight: 15, minDepth: 0.25, speed: 0.9, description: "A clever red octopus with grasping tentacles.", baseScale: 0.3 },
  ...
  { name: "Electric Eel", icon: "/assets/icons/fish/electric-eel-yellow-uncommon.png", catchAsset: "/assets/catch/electric-eel-yellow-uncommon.png", catchW: 36, catchH: 34, creatureFolder: "electric-eel-yellow-uncommon", idleFrames: 1, walkFrames: 2, points: 65, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 1.6, description: "A shocking eel crackling with electric charge.", baseScale: 0.035 },
  { name: "Blue Ring Octopus", icon: "/assets/icons/fish/blue-ring-octopus-blue-uncommon.png", catchAsset: "/assets/catch/blue-ring-octopus-blue-uncommon.png", catchW: 35, catchH: 32, creatureFolder: "blue-ring-octopus-blue-uncommon", idleFrames: 6, walkFrames: 6, points: 55, rarity: "uncommon", weight: 8, minDepth: 0.35, speed: 1.0, description: "A small but deadly octopus with glowing blue rings.", baseScale: 0.2 },
  ...
  { name: "Anglerfish", icon: "/assets/icons/fish/anglerfish-dark-rare.png", catchAsset: "/assets/catch/anglerfish-dark-rare.png", catchW: 78, catchH: 20, creatureFolder: "anglerfish-dark-rare", idleFrames: 2, walkFrames: 2, points: 120, rarity: "rare", weight: 5, minDepth: 0.55, speed: 0.6, description: "A deep-sea predator with a bioluminescent lure.", baseScale: 0.5 },
  { name: "Deep Sea Angler", icon: "/assets/icons/fish/deep-sea-angler-dark-rare.png", catchAsset: "/assets/catch/deep-sea-angler-dark-rare.png", catchW: 78, catchH: 20, creatureFolder: "deep-sea-angler-dark-rare", idleFrames: 2, walkFrames: 2, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow.", baseScale: 0.6 },
  { name: "Phantom Minnow", icon: "/assets/icons/fish/phantom-minnow-spectral-ultra_rare.png", catchAsset: "/assets/catch/phantom-minnow-spectral-ultra_rare.png", catchW: 96, catchH: 48, creatureFolder: "phantom-minnow-spectral-ultra_rare", idleFrames: 4, walkFrames: 4, points: 500, rarity: "ultra_rare", weight: 0.3, minDepth: 0.55, speed: 2.2, description: "A ghostly minnow wreathed in spectral flame. Blinks in and out of reality.", baseScale: 0.3 },
  { name: "Volcanic Perch", icon: "/assets/icons/fish/volcanic-perch-molten-ultra_rare.png", catchAsset: "/assets/catch/volcanic-perch-molten-ultra_rare.png", catchW: 33, catchH: 25, creatureFolder: "volcanic-perch-molten-ultra_rare", idleFrames: 4, walkFrames: 4, points: 600, rarity: "ultra_rare", weight: 0.25, minDepth: 0.6, speed: 1.6, description: "A perch superheated by deep-sea vents. Its scales glow molten orange.", baseScale: 0.4 },
  { name: "Abyssal Bass", icon: "/assets/icons/fish/abyssal-bass-dark-ultra_rare.png", catchAsset: "/assets/catch/abyssal-bass-dark-ultra_rare.png", catchW: 48, catchH: 41, creatureFolder: "abyssal-bass-dark-ultra_rare", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches. Radiates dark energy.", baseScale: 0.7 },
  { name: "Frost Catfish", icon: "/assets/icons/fish/frost-catfish-ice-ultra_rare.png", catchAsset: "/assets/catch/frost-catfish-ice-ultra_rare.png", catchW: 40, catchH: 32, creatureFolder: "frost-catfish-ice-ultra_rare", idleFrames: 4, walkFrames: 4, points: 800, rarity: "ultra_rare", weight: 0.18, minDepth: 0.6, speed: 0.9, description: "An ancient catfish encased in living ice. Freezes the water around it.", baseScale: 0.75 },
  { name: "Storm Swordfish", icon: "/assets/icons/fish/storm-swordfish-electric-ultra_rare.png", catchAsset: "/assets/catch/storm-swordfish-electric-ultra_rare.png", catchW: 92, catchH: 22, creatureFolder: "storm-swordfish-electric-ultra_rare", idleFrames: 4, walkFrames: 4, points: 1000, rarity: "ultra_rare", weight: 0.12, minDepth: 0.7, speed: 2.5, description: "A swordfish that rides lightning bolts. Crackles with electric fury.", baseScale: 1.5 },
  { name: "Celestial Whale", icon: "/assets/icons/fish/celestial-whale-cosmic-ultra_rare.png", catchAsset: "/assets/catch/celestial-whale-cosmic-ultra_rare.png", catchW: 96, catchH: 48, creatureFolder: "celestial-whale-cosmic-ultra_rare", idleFrames: 2, walkFrames: 2, points: 2000, rarity: "ultra_rare", weight: 0.05, minDepth: 0.75, speed: 0.4, description: "A cosmic whale that swallowed a dying star. The rarest creature in existence.", baseScale: 3.5 },
  ...
  { name: "The Seal at the Seam", icon: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", catchAsset: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", catchW: 64, catchH: 64, creatureFolder: "seal-at-the-seam-cosmic-ultra_rare", idleFrames: 1, walkFrames: 1, points: 5000, rarity: "ultra_rare", weight: 0, minDepth: 0.95, speed: 0.3, description: "A living sigil at the boundary of reality. The 10th Legendary — guardian of the Seam.", tint: "rgba(20,40,120,0.5)", baseScale: 1.0, staticImg: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", treasureChestOnly: true },
];
...
const BEACH_CRABS: FishType[] = [
  { name: "Red Crab", icon: "/assets/icons/fish/red-crab-red-common.png", catchAsset: "/assets/icons/fish/red-crab-red-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 1, walkFrames: 4, points: 8, rarity: "common", weight: 50, minDepth: 0.05, speed: 0.9, description: "A small red crab that scuttles along the beach.", beachCrab: true, spriteSheet: "/assets/crabs/red-crab-red-common.png", spriteRow: 0, spriteFrameSize: 32 },
    ...
    const gameLoop = (timestamp: number) => {
      ...
      const rockCliffImg = getImg("/assets/tiles/rock_cliff_wall.png");
      {
        ...
        for (let tx = terrainStartX; tx < viewR + terrainStep; tx += terrainStep) {
          if (tx > waterRightEdge) break;
          if (tx + terrainStep > waterRightEdge) continue;
          const floorAtX = getOceanFloorY(tx, waterY, W, H);
          const floorAtNext = getOceanFloorY(tx + terrainStep, waterY, W, H);
          const terrainH = 80 + Math.sin(tx * 0.01) * 20;
          const chosenImg = tx % 120 < 60 ? rockFloorImg : rockCliffImg;
      ...
      for (let i = s.swimmingFish.length - 1; i >= 0; i--) {
        ...
        if (fish.type.beachCrab && fish.type.spriteSheet) {
          ...
          if (crabImg && crabImg.complete) {
            const fs = fish.type.spriteFrameSize || 128;
            const crabDrawSize = SCALE * 12 * fish.sizeMultiplier;
            const frameIdx = fish.frame % Math.max(1, fish.type.walkFrames);
            const sx = frameIdx * fs;
            const sy = (fish.type.spriteRow || 0) * fs;
            ...
            ctx.drawImage(crabImg, sx, sy, fs, fs, -crabDrawSize / 2, -crabDrawSize / 2, crabDrawSize, crabDrawSize);
            ctx.restore();
          }
          ...
          if (staticImgEl && staticImgEl.complete && staticImgEl.naturalWidth > 0) {
            const sScale = creatureScale * 0.7;
      ...
      if (s.gameState === "waiting") {
        ...
        if (eqLure.crabSpriteSheet) {
          ...
          if (crabSheet && crabSheet.complete && crabSheet.naturalWidth > 0) {
            const crabFS = crabSheet.naturalWidth;
