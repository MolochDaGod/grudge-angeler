...
const FISH_TYPES: FishType[] = [
  { name: "Minnow", icon: "/assets/icons/fish/minnow-silver-common.png", catchAsset: "/assets/catch/minnow-silver-common.png", catchW: 45, catchH: 42, creatureFolder: "minnow-silver-common", idleFrames: 4, walkFrames: 4, points: 10, rarity: "common", weight: 40, minDepth: 0.15, speed: 1.5, description: "A tiny silver fish, common in shallow waters.", tint: "rgba(200,210,230,0.2)", baseScale: 0.6 },
  ...
  { name: "Perch", icon: "/assets/icons/fish/perch-striped-common.png", catchAsset: "/assets/catch/perch-striped-common.png", catchW: 45, catchH: 42, creatureFolder: "perch-striped-common", idleFrames: 4, walkFrames: 4, points: 25, rarity: "common", weight: 30, minDepth: 0.25, speed: 1.2, description: "A striped freshwater fish with sharp fins." },
  ...
  { name: "Swordfish", icon: "/assets/icons/fish/swordfish-blue-rare.png", catchAsset: "/assets/catch/swordfish-blue-rare.png", catchW: 44, catchH: 22, creatureFolder: "swordfish-blue-rare", idleFrames: 4, walkFrames: 4, points: 150, rarity: "rare", weight: 4, minDepth: 0.55, speed: 1.8, description: "A powerful ocean predator with a sharp bill." },
  { name: "Stingray", icon: "/assets/icons/fish/stingray-gray-rare.png", catchAsset: "/assets/catch/stingray-gray-rare.png", catchW: 59, catchH: 11, creatureFolder: "stingray-gray-rare", idleFrames: 4, walkFrames: 4, points: 100, rarity: "rare", weight: 5, minDepth: 0.45, speed: 1.4, description: "A flat-bodied ray gliding silently along the ocean floor.", tint: "rgba(100,110,130,0.25)", baseScale: 1.2 },
  { name: "Whale", icon: "/assets/icons/fish/whale-blue-legendary.png", catchAsset: "/assets/catch/whale-blue-legendary.png", catchW: 84, catchH: 54, creatureFolder: "whale-blue-legendary", idleFrames: 4, walkFrames: 4, points: 300, rarity: "legendary", weight: 1, minDepth: 0.65, speed: 0.5, description: "The king of the deep. Incredibly rare!", tint: "rgba(40,80,180,0.45)", baseScale: 1.8 },
  { name: "Kraken", icon: "/assets/icons/fish/kraken-crimson-legendary.png", catchAsset: "/assets/catch/kraken-crimson-legendary.png", catchW: 96, catchH: 96, creatureFolder: "kraken-crimson-legendary", idleFrames: 6, walkFrames: 6, points: 400, rarity: "legendary", weight: 0.8, minDepth: 0.7, speed: 0.7, description: "A crimson terror from the deep. Its tentacles crush ships.", tint: "rgba(140,30,20,0.35)", baseScale: 2.0 },
  { name: "Giant Squid", icon: "/assets/icons/fish/giant-squid-blue-legendary.png", catchAsset: "/assets/catch/giant-squid-blue-legendary.png", catchW: 96, catchH: 96, creatureFolder: "giant-squid-blue-legendary", idleFrames: 6, walkFrames: 6, points: 130, rarity: "rare", weight: 4, minDepth: 0.55, speed: 0.8, description: "A massive blue squid from the abyss. Eyes the size of dinner plates.", tint: "rgba(30,60,160,0.35)", baseScale: 1.9 },
  { name: "Giant Octopus", icon: "/assets/icons/fish/giant-octopus-purple-legendary.png", catchAsset: "/assets/catch/giant-octopus-purple-legendary.png", catchW: 96, catchH: 96, creatureFolder: "giant-octopus-purple-legendary", idleFrames: 6, walkFrames: 6, points: 70, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 0.6, description: "A purple giant with eight crushing arms. Incredibly intelligent.", tint: "rgba(120,20,140,0.35)", baseScale: 2.0 },
  { name: "Eel", icon: "/assets/icons/fish/eel-dark-common.png", catchAsset: "/assets/catch/eel-dark-common.png", catchW: 36, catchH: 11, creatureFolder: "eel-dark-common", idleFrames: 4, walkFrames: 6, points: 40, rarity: "common", weight: 20, minDepth: 0.3, speed: 1.3, description: "A slippery serpentine fish.", tint: "rgba(50,60,70,0.15)" },
  { name: "Octopus", icon: "/assets/icons/fish/octopus-red-common.png", catchAsset: "/assets/catch/octopus-red-common.png", catchW: 35, catchH: 32, creatureFolder: "octopus-red-common", idleFrames: 6, walkFrames: 6, points: 35, rarity: "common", weight: 15, minDepth: 0.25, speed: 0.9, description: "A clever red octopus with grasping tentacles." },
  { name: "Salmon", icon: "/assets/icons/fish/salmon-pink-uncommon.png", catchAsset: "/assets/catch/salmon-pink-uncommon.png", catchW: 45, catchH: 42, creatureFolder: "salmon-pink-uncommon", idleFrames: 4, walkFrames: 4, points: 60, rarity: "uncommon", weight: 12, minDepth: 0.35, speed: 1.1, description: "A prized pink-fleshed fish.", tint: "rgba(220,100,80,0.4)" },
  { name: "Electric Eel", icon: "/assets/icons/fish/electric-eel-yellow-uncommon.png", catchAsset: "/assets/catch/electric-eel-yellow-uncommon.png", catchW: 36, catchH: 11, creatureFolder: "electric-eel-yellow-uncommon", idleFrames: 4, walkFrames: 6, points: 65, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 1.6, description: "A shocking eel crackling with electric charge." },
  { name: "Blue Ring Octopus", icon: "/assets/icons/fish/blue-ring-octopus-blue-uncommon.png", catchAsset: "/assets/catch/blue-ring-octopus-blue-uncommon.png", catchW: 35, catchH: 32, creatureFolder: "blue-ring-octopus-blue-uncommon", idleFrames: 6, walkFrames: 6, points: 55, rarity: "uncommon", weight: 8, minDepth: 0.35, speed: 1.0, description: "A small but deadly octopus with glowing blue rings." },
  { name: "Moray Eel", icon: "/assets/icons/fish/moray-eel-brown-rare.png", catchAsset: "/assets/catch/moray-eel-brown-rare.png", catchW: 36, catchH: 11, creatureFolder: "moray-eel-brown-rare", idleFrames: 4, walkFrames: 6, points: 90, rarity: "rare", weight: 6, minDepth: 0.5, speed: 1.1, description: "A thick-bodied eel lurking in reef crevices." },
  { name: "Anglerfish", icon: "/assets/icons/fish/anglerfish-dark-rare.png", catchAsset: "/assets/catch/anglerfish-dark-rare.png", catchW: 30, catchH: 20, creatureFolder: "anglerfish-dark-rare", idleFrames: 4, walkFrames: 4, points: 120, rarity: "rare", weight: 5, minDepth: 0.55, speed: 0.6, description: "A deep-sea predator with a bioluminescent lure." },
  { name: "Deep Sea Angler", icon: "/assets/icons/fish/deep-sea-angler-dark-rare.png", catchAsset: "/assets/catch/deep-sea-angler-dark-rare.png", catchW: 30, catchH: 20, creatureFolder: "deep-sea-angler-dark-rare", idleFrames: 4, walkFrames: 4, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow." },
  { name: "Phantom Minnow", icon: "/assets/icons/fish/phantom-minnow-spectral-ultra_rare.png", catchAsset: "/assets/catch/phantom-minnow-spectral-ultra_rare.png", catchW: 48, catchH: 48, creatureFolder: "phantom-minnow-spectral-ultra_rare", idleFrames: 4, walkFrames: 4, points: 500, rarity: "ultra_rare", weight: 0.3, minDepth: 0.55, speed: 2.2, description: "A ghostly minnow wreathed in spectral flame. Blinks in and out of reality.", baseScale: 1.8 },
  { name: "Volcanic Perch", icon: "/assets/icons/fish/volcanic-perch-molten-ultra_rare.png", catchAsset: "/assets/catch/volcanic-perch-molten-ultra_rare.png", catchW: 33, catchH: 25, creatureFolder: "volcanic-perch-molten-ultra_rare", idleFrames: 4, walkFrames: 4, points: 600, rarity: "ultra_rare", weight: 0.25, minDepth: 0.6, speed: 1.6, description: "A perch superheated by deep-sea vents. Its scales glow molten orange.", baseScale: 2.0 },
  { name: "Abyssal Bass", icon: "/assets/icons/fish/abyssal-bass-dark-ultra_rare.png", catchAsset: "/assets/catch/abyssal-bass-dark-ultra_rare.png", catchW: 48, catchH: 41, creatureFolder: "abyssal-bass-dark-ultra_rare", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches. Radiates dark energy.", baseScale: 2.2 },
  { name: "Frost Catfish", icon: "/assets/icons/fish/frost-catfish-ice-ultra_rare.png", catchAsset: "/assets/catch/frost-catfish-ice-ultra_rare.png", catchW: 40, catchH: 32, creatureFolder: "frost-catfish-ice-ultra_rare", idleFrames: 4, walkFrames: 4, points: 800, rarity: "ultra_rare", weight: 0.18, minDepth: 0.6, speed: 0.9, description: "An ancient catfish encased in living ice. Freezes the water around it.", baseScale: 2.3 },
  { name: "Storm Swordfish", icon: "/assets/icons/fish/storm-swordfish-electric-ultra_rare.png", catchAsset: "/assets/catch/storm-swordfish-electric-ultra_rare.png", catchW: 48, catchH: 32, creatureFolder: "storm-swordfish-electric-ultra_rare", idleFrames: 4, walkFrames: 4, points: 1000, rarity: "ultra_rare", weight: 0.12, minDepth: 0.7, speed: 2.5, description: "A swordfish that rides lightning bolts. Crackles with electric fury.", baseScale: 2.0 },
  { name: "Celestial Whale", icon: "/assets/icons/fish/celestial-whale-cosmic-ultra_rare.png", catchAsset: "/assets/catch/celestial-whale-cosmic-ultra_rare.png", catchW: 48, catchH: 32, creatureFolder: "celestial-whale-cosmic-ultra_rare", idleFrames: 4, walkFrames: 4, points: 2000, rarity: "ultra_rare", weight: 0.05, minDepth: 0.75, speed: 0.4, description: "A cosmic whale that swallowed a dying star. The rarest creature in existence.", baseScale: 2.5 },
  ...
  { name: "Shadow Leviathan", icon: "/assets/icons/fish/shadow-leviathan-shadow-ultra_rare.png", catchAsset: "/assets/catch/shadow-leviathan-shadow-ultra_rare.png", catchW: 55, catchH: 59, creatureFolder: "shadow-leviathan-shadow-ultra_rare", idleFrames: 4, walkFrames: 4, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss. Feared by all ocean life.", tint: "rgba(140,15,15,0.5)", baseScale: 2.5 },
...
const BEACH_CRABS: FishType[] = [
  { name: "Red Crab", icon: "/assets/icons/fish/red-crab-red-common.png", catchAsset: "/assets/icons/fish/red-crab-red-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 8, rarity: "common", weight: 50, minDepth: 0.05, speed: 0.9, description: "A small red crab that scuttles along the beach.", beachCrab: true, spriteSheet: "/assets/crabs/red-crab-red-common.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Blue Crab", icon: "/assets/icons/fish/blue-crab-blue-common.png", catchAsset: "/assets/icons/fish/blue-crab-blue-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 10, rarity: "common", weight: 40, minDepth: 0.05, speed: 1.0, description: "A bright blue crab found near tidal pools.", beachCrab: true, spriteSheet: "/assets/crabs/blue-crab-blue-common.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Green Crab", icon: "/assets/icons/fish/green-crab-green-common.png", catchAsset: "/assets/icons/fish/green-crab-green-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 8, rarity: "common", weight: 45, minDepth: 0.05, speed: 0.8, description: "A mossy green crab hiding in the seaweed.", beachCrab: true, spriteSheet: "/assets/crabs/green-crab-green-common.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Purple Crab", icon: "/assets/icons/fish/purple-crab-purple-uncommon.png", catchAsset: "/assets/icons/fish/purple-crab-purple-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 15, rarity: "uncommon", weight: 20, minDepth: 0.05, speed: 1.1, description: "An uncommon purple crab with iridescent shell.", beachCrab: true, spriteSheet: "/assets/crabs/purple-crab-purple-uncommon.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Gold Crab", icon: "/assets/icons/fish/gold-crab-gold-uncommon.png", catchAsset: "/assets/icons/fish/gold-crab-gold-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 25, rarity: "uncommon", weight: 15, minDepth: 0.05, speed: 1.2, description: "A rare golden crab. Prized for its shimmering shell.", beachCrab: true, spriteSheet: "/assets/crabs/gold-crab-gold-uncommon.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Cyan Crab", icon: "/assets/icons/fish/cyan-crab-cyan-common.png", catchAsset: "/assets/icons/fish/cyan-crab-cyan-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 8, rarity: "common", weight: 45, minDepth: 0.05, speed: 0.85, description: "A pale cyan crab commonly found on sandy shores.", beachCrab: true, spriteSheet: "/assets/crabs/cyan-crab-cyan-common.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Pink Crab", icon: "/assets/icons/fish/pink-crab-pink-common.png", catchAsset: "/assets/icons/fish/pink-crab-pink-common.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 12, rarity: "common", weight: 35, minDepth: 0.05, speed: 0.95, description: "A cute pink crab that loves warm shallow waters.", beachCrab: true, spriteSheet: "/assets/crabs/pink-crab-pink-common.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Dark Crab", icon: "/assets/icons/fish/dark-crab-dark-uncommon.png", catchAsset: "/assets/icons/fish/dark-crab-dark-uncommon.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 20, rarity: "uncommon", weight: 18, minDepth: 0.05, speed: 1.15, description: "A dark-shelled crab with powerful pincers.", beachCrab: true, spriteSheet: "/assets/crabs/dark-crab-dark-uncommon.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Crimson Crab", icon: "/assets/icons/fish/crimson-crab-crimson-rare.png", catchAsset: "/assets/icons/fish/crimson-crab-crimson-rare.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 40, rarity: "rare", weight: 8, minDepth: 0.05, speed: 1.4, description: "A blood-red crab with Sea Devil markings. Extremely aggressive.", beachCrab: true, spriteSheet: "/assets/crabs/crimson-crab-crimson-rare.png", spriteRow: 1, spriteFrameSize: 32 },
  { name: "Shadow Crab", icon: "/assets/icons/fish/shadow-crab-shadow-rare.png", catchAsset: "/assets/icons/fish/shadow-crab-shadow-rare.png", catchW: 32, catchH: 32, creatureFolder: "", idleFrames: 4, walkFrames: 4, points: 55, rarity: "rare", weight: 5, minDepth: 0.05, speed: 1.6, description: "A dark maroon crab that moves like a phantom. Kin of the Sea Devil.", beachCrab: true, spriteSheet: "/assets/crabs/shadow-crab-shadow-rare.png", spriteRow: 1, spriteFrameSize: 32 },
];
...
const FISHING_ATTR_DEFS: Record<keyof FishingAttributes, { description: string; color: string; gains: Record<string, { label: string; perPoint: number; unit: string }> }> = {
  Strength: {
    description: "Raw reeling power. Bigger catch zone, stronger drag, and Force Pool.",
    color: "#ef4444",
    gains: {
      dragForce: { label: "Drag Force", perPoint: 3.0, unit: "%" },
      forcePool: { label: "Force Pool", perPoint: 1, unit: "" },
      catchZone: { label: "Catch Zone", perPoint: 0.6, unit: "%" },
    }
  },
  Intellect: {
    description: "Fishing knowledge. Better sell prices, cheaper Force, and more XP.",
    color: "#8b5cf6",
    gains: {
      sellBonus: { label: "Sell Price", perPoint: 2.5, unit: "%" },
      forceCostReduce: { label: "Force Cost", perPoint: 4, unit: "% off" },
      xpBonus: { label: "XP Gain", perPoint: 1.6, unit: "%" },
    }
  },
  Vitality: {
    description: "Stamina and endurance. Longer bite windows, faster Force regen, faster wait.",
    color: "#22c55e",
    gains: {
      biteWindow: { label: "Bite Window", perPoint: 2.0, unit: "%" },
      forceRegen: { label: "Force Regen", perPoint: 0.15, unit: "/s" },
      waitReduce: { label: "Wait Reduce", perPoint: 1.2, unit: "%" },
    }
  },
  Dexterity: {
    description: "Precision and finesse. Tames fish direction changes and steadier reeling.",
    color: "#f59e0b",
    gains: {
      fishControl: { label: "Fish Control", perPoint: 3.0, unit: "%" },
      reelDrift: { label: "Reel Drift", perPoint: 1.5, unit: "% less" },
      netSize: { label: "Net Width", perPoint: 2, unit: "px" },
    }
  },
  Endurance: {
    description: "Physical resilience. More resilience charges, stronger line, wider nets.",
    color: "#78716c",
    gains: {
      lineStrength: { label: "Line Strength", perPoint: 2.5, unit: "%" },
      resilience: { label: "Resilience", perPoint: 0.2, unit: "" },
      netDepth: { label: "Net Depth", perPoint: 2, unit: "px" },
    }
  },
  Wisdom: {
    description: "Deep ocean knowledge. Better rare fish spawns and lower Force cost.",
    color: "#06b6d4",
    gains: {
      rarityBoost: { label: "Rarity Boost", perPoint: 2.0, unit: "%" },
      forceMult: { label: "Force Cost", perPoint: -0.2, unit: "" },
    }
  },
  Agility: {
    description: "Speed and reflexes. Faster reeling, quicker movement, and Force Pool.",
    color: "#a3e635",
    gains: {
      reelSpeed: { label: "Reel Speed", perPoint: 1.6, unit: "%" },
      forcePool: { label: "Force Pool", perPoint: 1, unit: "" },
      moveSpeed: { label: "Move Speed", perPoint: 1.0, unit: "%" },
    }
  },
  Tactics: {
    description: "Strategic mastery. Amplifies ALL other attributes and bounty rewards.",
    color: "#ec4899",
    gains: {
      allStatsAmp: { label: "All Stats Amp", perPoint: 1.0, unit: "%" },
      bountyBonus: { label: "Bounty Bonus", perPoint: 2.0, unit: "%" },
      comboMulti: { label: "Combo Multi", perPoint: 0.6, unit: "%" },
    }
  },
};
...
export default function FishingGame() {
  ...
  const spawnFish = useCallback((canvasW: number, waterStartY: number, canvasH: number, spawnWorldX?: number) => {
    ...
    const wisdomBoost = 1 + s.attributes.Wisdom * 0.02 * (1 + s.attributes.Tactics * 0.01);
  ...
  const getSellPrice = useCallback((fishType: FishType | null, junk: typeof JUNK_ITEMS[0] | null, size: number) => {
    ...
    const intBonus = 1 + s.attributes.Intellect * 0.025 * (1 + s.attributes.Tactics * 0.01);
  ...
  useEffect(() => {
    ...
    const assets = [
      ...
      ...FISH_TYPES.filter(f => f.creatureFolder).flatMap(f => [
  ...
  const syncUI = useCallback(() => {
    ...
    setUiState({
      ...
      chumCooldown: s.chumCooldown,
      toolMode: s.toolMode,
      netActive: s.netActive,
      netCooldown: s.netCooldown,
      netBroken: s.netBroken,
  ...
  useEffect(() => {
    ...
    const gameLoop = (timestamp: number) => {
      ...
      if (s.gameState === "reeling") {
        ...
        const tacticsGlobal = 1 + a.Tactics * 0.01;

        const strMod = 1 + (a.Strength * 0.03 * tacticsGlobal);
        const agiMod = 1 + (a.Agility * 0.016 * tacticsGlobal);
        const dexMod = 1 + (a.Dexterity * 0.02 * tacticsGlobal);
        const endMod = 1 + (a.Endurance * 0.025 * tacticsGlobal);
        ...
        const dirChangeChance = (0.012 * difficultyMult) / (1 + a.Dexterity * 0.06 * tacticsGlobal);
        ...
        const fishSpeed = (0.004 + s.rodLevel * 0.0005) * difficultyMult * (1.0 / alignmentBonus) * distanceMult / (1 + a.Dexterity * 0.015 * tacticsGlobal);
        ...
        if (s.isReeling) {
          ...
          const driftRight = 0.04 * (1.0 / alignmentBonus) * dtSec / dexMod;
          s.reelProgress = Math.min(0.95, s.reelProgress + driftRight);
        }

        const rod = RODS[s.equippedRod];
        const catchZoneHalf = (0.08 + s.rodLevel * 0.015 + rod.catchZoneBonus + a.Strength * 0.006 * tacticsGlobal);
        ...
        if (fishInZone) {
          if (s.activeReelHeld && s.forceBar > 0) {
            const wisdomReduction = Math.max(0.5, 5 - a.Wisdom * 0.2);
            const baseForceCost = s.playerLevel * wisdomReduction;
            const intReduction = 1 - Math.min(0.9, a.Intellect * 0.04);
        ...
        if (!s.activeReelHeld || !fishInZone) {
          const forceRegenPerSec = 0.1 + 0.15 * a.Vitality;
          const dtSec3 = dt / 60;
        ...
        if (s.reelGauge >= 1.0) {
          ...
          if (bountyIdx >= 0) {
            const bountyTacticsBonus = 1 + s.attributes.Tactics * 0.02;
      ...
      if (s.chumActiveTimer > 0) {
        ...
        if (s.castLineLanded && Math.random() < 0.15 * chumItem.fishAttract * dt) {
          const colors = ["#f59e0b", "#88ffcc", "#fbbf24", "#22c55e"];
          addParticles(s.hookX + (Math.random() - 0.5) * 80, s.hookY + (Math.random() - 0.5) * 40, 3, colors[Math.floor(Math.random() * colors.length)], 2, "sparkle");
        }
        if (s.chumActiveTimer <= 0) {
          s.chumActiveType = -1;
          s.chumActiveTimer = 0;
      ...
      {uiState.gameState !== "title" && uiState.gameState !== "charSelect" && (
        <>
          ...
          {uiState.gameState === "reeling" && (() => {
            ...
            const tacticsG = 1 + uiState.attributes.Tactics * 0.01;
            const strZoneBonus = uiState.attributes.Strength * 0.006 * tacticsG;
          ...
          {/* Active Chum HUD */}
          {uiState.chumActiveType >= 0 && uiState.chumActiveTimer > 0 && (
            <div className="absolute flex items-center gap-2" style={{ left: 12, bottom: 'ontouchstart' in window ? 140 : 60, zIndex: 30, background: "rgba(8,15,25,0.9)", borderRadius: 8, border: "1px solid rgba(245,158,11,0.4)", padding: "5px 10px", minWidth: 140 }} data-testid="chum-hud">
              <img src={CHUM_ITEMS[uiState.chumActiveType].icon} alt="" style={{ width: 20, height: 20, imageRendering: "pixelated" }} />
              <div className="flex flex-col gap-0.5 flex-1">
                <span style={{ color: "#f59e0b", fontSize: 9, fontFamily: "'Press Start 2P', monospace" }}>{CHUM_ITEMS[uiState.chumActiveType].name}</span>
              ...
              <div onClick={(e) => { e.stopPropagation(); stateRef.current.selectedHotbar = 4; stateRef.current.toolMode = "net"; stateRef.current.showLurePopup = false; stateRef.current.showChumPopup = false; stateRef.current.binoculars = false; syncUI(); }}
                ...
                {uiState.netCooldown > 0 && (
                  <span style={{ position: "absolute", top: -4, right: -4, fontSize: 7, background: uiState.netBroken ? "rgba(220,38,38,0.9)" : "rgba(168,85,247,0.9)", color: "#fff", borderRadius: 4, padding: "1px 3px", fontWeight: "bold" }}>
                    {uiState.netBroken ? "BROKE" : `${Math.ceil(uiState.netCooldown / 60)}s`}
                  </span>
                )}
              </div>
                    ...
                    return (
                      <div key={chum.name} className="flex items-start gap-2.5 p-2.5" style={{ background: "rgba(255,255,255,0.03)", borderRadius: 8, border: "1px solid rgba(245,158,11,0.1)" }}>
                        ...
                        <div className="flex-1 min-w-0 flex flex-col gap-1">
                          ...
                          <div className="flex flex-wrap gap-x-3 gap-y-0.5">
                            <span style={{ color: "#78909c", fontSize: 8 }}>Duration: {Math.round(chum.duration / 60)}s</span>
                            <span style={{ color: "#78909c", fontSize: 8 }}>Cooldown: {Math.round(chum.cooldown / 60)}s</span>
                          </div>
                        </div>
                        <div className="flex flex-col items-end gap-1">
                          <button
                    ...
                    {uiState.npcTab === "mission" && npc.missions && (
                      <div className="flex flex-col gap-2">
                        ...
                        {npc.missions.map((mission: CrabMasterMission, mi: number) => {
                          ...
                          const crabBaitItem = LURES.find(b => b.crabName === mission.crabName);
                          const crabIcon = crabBaitItem?.icon || `/assets/icons/fish/${mission.crabName.toLowerCase().replace(/ /g, '-')}.png`;
                          return (
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div style={{ background: "rgba(0,0,0,0.2)", borderRadius: 8, padding: 10, border: "1px solid rgba(255,255,255,0.06)" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6 }}>
                      {(() => {
                        const tG = 1 + uiState.attributes.Tactics * 0.01;
                        const forcePool = 10 + Math.max(uiState.attributes.Strength, uiState.attributes.Agility);
                        const wisdomReduce = Math.max(0.5, 5 - uiState.attributes.Wisdom * 0.2);
                        const forceCostBase = uiState.playerLevel * wisdomReduce;
                        const intReduce = 1 - Math.min(0.9, uiState.attributes.Intellect * 0.04);
                        const forceCost = forceCostBase * intReduce;
                        const forceRegen = 0.1 + 0.15 * uiState.attributes.Vitality;
                        return [
                          { label: "Drag Force", value: `+${(uiState.attributes.Strength * 3.0 * tG).toFixed(0)}%`, color: "#ef4444" },
                          ...
                          { label: "Sell Bonus", value: `+${(uiState.attributes.Intellect * 2.5 * tG).toFixed(0)}%`, color: "#8b5cf6" },
                          { label: "Bite Window", value: `+${(uiState.attributes.Vitality * 2.0 * tG).toFixed(0)}%`, color: "#22c55e" },
                          { label: "Fish Control", value: `+${(uiState.attributes.Dexterity * 3.0 * tG).toFixed(0)}%`, color: "#f59e0b" },
                          { label: "Line Strength", value: `+${(uiState.attributes.Endurance * 2.5 * tG).toFixed(0)}%`, color: "#78716c" },
                          { label: "Rarity Boost", value: `+${(uiState.attributes.Wisdom * 2.0 * tG).toFixed(0)}%`, color: "#06b6d4" },
                          { label: "Reel Speed", value: `+${(uiState.attributes.Agility * 1.6 * tG).toFixed(0)}%`, color: "#a3e635" },
          ...
          {uiState.adminTab === "assets" && (
            <div style={{ flex: 1, overflowY: "auto", padding: 8 }}>
              {[
                ...
                { label: "Creatures (Swim)", items: FISH_TYPES.filter(f => f.creatureFolder).map(f => ({
                  name: `${f.name} Walk`, src: `/assets/creatures/${f.creatureFolder}/Walk.png`, frames: f.walkFrames,
                })) },
