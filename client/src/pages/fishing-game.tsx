...
const FISH_TYPES: FishType[] = [
  ...
  { name: "Abyssal Bass", icon: "/assets/icons/fish/abyssal-bass-dark-ultra_rare.png", catchAsset: "/assets/catch/abyssal-bass-dark-ultra_rare.png", catchW: 48, catchH: 41, creatureFolder: "abyssal-bass-dark-ultra_rare", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches. Radiates dark energy.", baseScale: 2.2, staticImg: "/assets/catch/abyssal-bass-dark-ultra_rare.png" },
