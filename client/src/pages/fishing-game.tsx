...
const FISH_TYPES: FishType[] = [
  ...
  { name: "Bass", icon: "/assets/icons/fish/bass-green-uncommon.png", catchAsset: "/assets/catch/bass-green-uncommon.png", catchW: 36, catchH: 34, creatureFolder: "bass-green-uncommon", idleFrames: 1, walkFrames: 2, points: 50, rarity: "uncommon", weight: 15, minDepth: 0.35, speed: 1.0, description: "A strong fighter popular with anglers." },
  ...
  { name: "Electric Eel", icon: "/assets/icons/fish/electric-eel-yellow-uncommon.png", catchAsset: "/assets/catch/electric-eel-yellow-uncommon.png", catchW: 36, catchH: 34, creatureFolder: "electric-eel-yellow-uncommon", idleFrames: 1, walkFrames: 2, points: 65, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 1.6, description: "A shocking eel crackling with electric charge." },
