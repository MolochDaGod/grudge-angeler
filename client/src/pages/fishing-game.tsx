...
const FISH_TYPES: FishType[] = [
  ...
  { name: "Deep Sea Angler", icon: "/assets/icons/fish/deep-sea-angler-dark-rare.png", catchAsset: "/assets/catch/deep-sea-angler-dark-rare.png", catchW: 78, catchH: 20, creatureFolder: "deep-sea-angler-dark-rare", idleFrames: 4, walkFrames: 4, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow.", baseScale: 0.6 },
  ...
  { name: "The Seal at the Seam", icon: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", catchAsset: "/assets/icons/fish/seal-at-the-seam-cosmic-ultra_rare.png", catchW: 64, catchH: 64, creatureFolder: "seal-at-the-seam-cosmic-ultra_rare", idleFrames: 6, walkFrames: 6, points: 5000, rarity: "ultra_rare", weight: 0, minDepth: 0.95, speed: 0.3, description: "A living sigil at the boundary of reality. The 10th Legendary — guardian of the Seam.", tint: "rgba(20,40,120,0.5)", baseScale: 1.0, treasureChestOnly: true },
];
