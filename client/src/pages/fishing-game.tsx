...
const FISH_TYPES: FishType[] = [
  ...
  { name: "Shadow Leviathan", icon: "/assets/gen-icons/fish-shadow-leviathan.png", catchAsset: "/assets/catch/shadow-leviathan.png", catchW: 48, catchH: 48, creatureFolder: "15", idleFrames: 4, walkFrames: 4, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss. Feared by all ocean life.", baseScale: 2.5 },
