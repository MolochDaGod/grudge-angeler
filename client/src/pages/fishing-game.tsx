...
const FISH_TYPES: FishType[] = [
  { name: "Minnow", icon: "/assets/gen-icons/fish-minnow.png", catchAsset: "/assets/catch/minnow.png", catchW: 48, catchH: 48, creatureFolder: "2", idleFrames: 4, walkFrames: 6, points: 10, rarity: "common", weight: 40, minDepth: 0.15, speed: 1.5, description: "A tiny silver fish, common in shallow waters.", tint: "rgba(200,210,230,0.2)", baseScale: 0.6 },
  { name: "Jellyfish", icon: "/assets/gen-icons/fish-jellyfish.png", catchAsset: "/assets/catch/jellyfish.png", catchW: 48, catchH: 48, creatureFolder: "1", idleFrames: 4, walkFrames: 4, points: 20, rarity: "common", weight: 25, minDepth: 0.2, speed: 0.7, description: "A translucent jellyfish drifting with the current.", tint: "rgba(120,80,255,0.2)" },
  { name: "Perch", icon: "/assets/gen-icons/fish-perch.png", catchAsset: "/assets/catch/perch.png", catchW: 48, catchH: 48, creatureFolder: "2", idleFrames: 4, walkFrames: 6, points: 25, rarity: "common", weight: 30, minDepth: 0.25, speed: 1.2, description: "A striped freshwater fish with sharp fins." },
  { name: "Bass", icon: "/assets/gen-icons/fish-bass.png", catchAsset: "/assets/catch/bass.png", catchW: 48, catchH: 48, creatureFolder: "2", idleFrames: 4, walkFrames: 6, points: 50, rarity: "uncommon", weight: 15, minDepth: 0.35, speed: 1.0, description: "A strong fighter popular with anglers.", tint: "rgba(60,80,40,0.3)" },
  { name: "Catfish", icon: "/assets/gen-icons/fish-catfish.png", catchAsset: "/assets/catch/catfish.png", catchW: 48, catchH: 48, creatureFolder: "4", idleFrames: 4, walkFrames: 4, points: 75, rarity: "uncommon", weight: 8, minDepth: 0.45, speed: 0.8, description: "A bottom-dweller with long whiskers.", tint: "rgba(160,120,80,0.15)" },
  { name: "Swordfish", icon: "/assets/gen-icons/fish-swordfish.png", catchAsset: "/assets/catch/swordfish.png", catchW: 48, catchH: 48, creatureFolder: "3", idleFrames: 4, walkFrames: 4, points: 150, rarity: "rare", weight: 4, minDepth: 0.55, speed: 1.8, description: "A powerful ocean predator with a sharp bill." },
  { name: "Stingray", icon: "/assets/gen-icons/fish-stingray.png", catchAsset: "/assets/catch/stingray.png", catchW: 60, catchH: 12, creatureFolder: "3", idleFrames: 4, walkFrames: 4, points: 100, rarity: "rare", weight: 5, minDepth: 0.45, speed: 1.4, description: "A flat-bodied ray gliding silently along the ocean floor.", tint: "rgba(100,110,130,0.25)", baseScale: 1.2 },
  { name: "Whale", icon: "/assets/gen-icons/fish-whale.png", catchAsset: "/assets/catch/whale.png", catchW: 48, catchH: 48, creatureFolder: "4", idleFrames: 4, walkFrames: 4, points: 300, rarity: "legendary", weight: 1, minDepth: 0.65, speed: 0.5, description: "The king of the deep. Incredibly rare!", tint: "rgba(40,80,180,0.45)", baseScale: 1.8 },
  { name: "Eel", icon: "/assets/gen-icons/fish-eel.png", catchAsset: "/assets/catch/eel.png", catchW: 48, catchH: 48, creatureFolder: "5", idleFrames: 4, walkFrames: 6, points: 40, rarity: "common", weight: 20, minDepth: 0.3, speed: 1.3, description: "A slippery serpentine fish.", tint: "rgba(50,60,70,0.15)" },
  { name: "Octopus", icon: "/assets/gen-icons/fish-octopus.png", catchAsset: "/assets/catch/octopus.png", catchW: 48, catchH: 48, creatureFolder: "6", idleFrames: 4, walkFrames: 6, points: 35, rarity: "common", weight: 15, minDepth: 0.25, speed: 0.9, description: "A clever red octopus with grasping tentacles." },
  { name: "Salmon", icon: "/assets/gen-icons/fish-salmon.png", catchAsset: "/assets/catch/salmon.png", catchW: 48, catchH: 48, creatureFolder: "2", idleFrames: 4, walkFrames: 6, points: 60, rarity: "uncommon", weight: 12, minDepth: 0.35, speed: 1.1, description: "A prized pink-fleshed fish.", tint: "rgba(220,100,80,0.4)" },
  { name: "Electric Eel", icon: "/assets/gen-icons/fish-electric-eel.png", catchAsset: "/assets/catch/electric-eel.png", catchW: 48, catchH: 48, creatureFolder: "16", idleFrames: 4, walkFrames: 6, points: 65, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 1.6, description: "A shocking eel crackling with electric charge." },
  { name: "Blue Ring Octopus", icon: "/assets/gen-icons/fish-blue-octopus.png", catchAsset: "/assets/catch/blue-ring-octopus.png", catchW: 48, catchH: 48, creatureFolder: "17", idleFrames: 4, walkFrames: 6, points: 55, rarity: "uncommon", weight: 8, minDepth: 0.35, speed: 1.0, description: "A small but deadly octopus with glowing blue rings." },
  { name: "Moray Eel", icon: "/assets/gen-icons/fish-moray-eel.png", catchAsset: "/assets/catch/moray-eel.png", catchW: 48, catchH: 48, creatureFolder: "18", idleFrames: 4, walkFrames: 6, points: 90, rarity: "rare", weight: 6, minDepth: 0.5, speed: 1.1, description: "A thick-bodied eel lurking in reef crevices." },
  { name: "Anglerfish", icon: "/assets/gen-icons/fish-anglerfish.png", catchAsset: "/assets/catch/anglerfish.png", catchW: 48, catchH: 48, creatureFolder: "4", idleFrames: 4, walkFrames: 4, points: 120, rarity: "rare", weight: 5, minDepth: 0.55, speed: 0.6, description: "A deep-sea predator with a bioluminescent lure." },
  { name: "Deep Sea Angler", icon: "/assets/gen-icons/fish-deep-angler.png", catchAsset: "/assets/catch/deep-sea-angler.png", catchW: 48, catchH: 48, creatureFolder: "19", idleFrames: 4, walkFrames: 4, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow." },
  ...
  { name: "Volcanic Perch", icon: "/assets/gen-icons/fish-volcanic-perch.png", catchAsset: "/assets/catch/volcanic-perch.png", catchW: 48, catchH: 48, creatureFolder: "8", idleFrames: 4, walkFrames: 4, points: 600, rarity: "ultra_rare", weight: 0.25, minDepth: 0.6, speed: 1.6, description: "A perch superheated by deep-sea vents. Its scales glow molten orange.", baseScale: 2.0 },
  { name: "Abyssal Bass", icon: "/assets/gen-icons/fish-abyssal-bass.png", catchAsset: "/assets/catch/abyssal-bass.png", catchW: 48, catchH: 48, creatureFolder: "9", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches. Radiates dark energy.", baseScale: 2.2 },
  { name: "Frost Catfish", icon: "/assets/gen-icons/fish-frost-catfish.png", catchAsset: "/assets/catch/frost-catfish.png", catchW: 48, catchH: 48, creatureFolder: "10", idleFrames: 4, walkFrames: 4, points: 800, rarity: "ultra_rare", weight: 0.18, minDepth: 0.6, speed: 0.9, description: "An ancient catfish encased in living ice. Freezes the water around it.", baseScale: 2.3 },
  { name: "Storm Swordfish", icon: "/assets/gen-icons/fish-storm-swordfish.png", catchAsset: "/assets/catch/storm-swordfish.png", catchW: 48, catchH: 48, creatureFolder: "11", idleFrames: 4, walkFrames: 4, points: 1000, rarity: "ultra_rare", weight: 0.12, minDepth: 0.7, speed: 2.5, description: "A swordfish that rides lightning bolts. Crackles with electric fury.", baseScale: 2.0 },
  { name: "Celestial Whale", icon: "/assets/gen-icons/fish-celestial-whale.png", catchAsset: "/assets/catch/celestial-whale.png", catchW: 48, catchH: 48, creatureFolder: "12", idleFrames: 4, walkFrames: 4, points: 2000, rarity: "ultra_rare", weight: 0.05, minDepth: 0.75, speed: 0.4, description: "A cosmic whale that swallowed a dying star. The rarest creature in existence.", baseScale: 2.5 },
  { name: "Neon Eel", icon: "/assets/gen-icons/fish-neon-eel.png", catchAsset: "/assets/catch/neon-eel.png", catchW: 48, catchH: 48, creatureFolder: "13", idleFrames: 4, walkFrames: 4, points: 650, rarity: "ultra_rare", weight: 0.22, minDepth: 0.55, speed: 1.9, description: "A bioluminescent eel pulsing with neon colors. Mesmerizing.", baseScale: 2.0 },
  { name: "Golden Salmon", icon: "/assets/gen-icons/fish-golden-salmon.png", catchAsset: "/assets/catch/golden-salmon.png", catchW: 48, catchH: 48, creatureFolder: "14", idleFrames: 4, walkFrames: 4, points: 700, rarity: "ultra_rare", weight: 0.2, minDepth: 0.6, speed: 1.5, description: "A legendary salmon with solid gold scales. Worth a fortune.", baseScale: 2.1 },
  { name: "Shadow Leviathan", icon: "/assets/gen-icons/fish-shadow-leviathan.png", catchAsset: "/assets/catch/shadow-leviathan.png", catchW: 96, catchH: 96, creatureFolder: "15", idleFrames: 4, walkFrames: 4, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss. Feared by all ocean life.", tint: "rgba(140,15,15,0.5)", baseScale: 2.5 },
