...
const FISH_TYPES: FishType[] = [
  ...
  { name: "Electric Eel", icon: "/assets/gen-icons/fish-electric-eel.png", catchAsset: "/assets/catch/7.png", catchW: 60, catchH: 12, creatureFolder: "16", idleFrames: 4, walkFrames: 6, points: 65, rarity: "uncommon", weight: 10, minDepth: 0.4, speed: 1.6, description: "A shocking eel crackling with electric charge." },
  { name: "Blue Ring Octopus", icon: "/assets/gen-icons/fish-blue-octopus.png", catchAsset: "/assets/catch/4.png", catchW: 40, catchH: 40, creatureFolder: "17", idleFrames: 4, walkFrames: 6, points: 55, rarity: "uncommon", weight: 8, minDepth: 0.35, speed: 1.0, description: "A small but deadly octopus with glowing blue rings." },
  { name: "Moray Eel", icon: "/assets/gen-icons/fish-moray-eel.png", catchAsset: "/assets/catch/7.png", catchW: 60, catchH: 12, creatureFolder: "18", idleFrames: 4, walkFrames: 6, points: 90, rarity: "rare", weight: 6, minDepth: 0.5, speed: 1.1, description: "A thick-bodied eel lurking in reef crevices." },
  ...
  { name: "Deep Sea Angler", icon: "/assets/gen-icons/fish-deep-angler.png", catchAsset: "/assets/catch/4.png", catchW: 52, catchH: 12, creatureFolder: "19", idleFrames: 4, walkFrames: 4, points: 140, rarity: "rare", weight: 3, minDepth: 0.65, speed: 0.5, description: "A pitch-black anglerfish with a sinister yellow glow." },
  ...
  { name: "Abyssal Bass", icon: "/assets/gen-icons/fish-abyssal-bass.png", catchAsset: "/assets/catch/3.png", catchW: 40, catchH: 12, creatureFolder: "9", idleFrames: 4, walkFrames: 4, points: 750, rarity: "ultra_rare", weight: 0.2, minDepth: 0.65, speed: 1.4, description: "A colossal bass from the deepest trenches. Radiates dark energy.", baseScale: 2.2 },
  { name: "Frost Catfish", icon: "/assets/gen-icons/fish-frost-catfish.png", catchAsset: "/assets/catch/4.png", catchW: 52, catchH: 12, creatureFolder: "10", idleFrames: 4, walkFrames: 4, points: 800, rarity: "ultra_rare", weight: 0.18, minDepth: 0.6, speed: 0.9, description: "An ancient catfish encased in living ice. Freezes the water around it.", baseScale: 2.3 },
  ...
  { name: "Neon Eel", icon: "/assets/gen-icons/fish-neon-eel.png", catchAsset: "/assets/catch/7.png", catchW: 60, catchH: 12, creatureFolder: "13", idleFrames: 4, walkFrames: 4, points: 650, rarity: "ultra_rare", weight: 0.22, minDepth: 0.55, speed: 1.9, description: "A bioluminescent eel pulsing with neon colors. Mesmerizing.", baseScale: 2.0 },
  ...
  { name: "Shadow Leviathan", icon: "/assets/gen-icons/fish-shadow-leviathan.png", catchAsset: "/assets/catch/5.png", catchW: 56, catchH: 24, creatureFolder: "15", idleFrames: 4, walkFrames: 4, points: 1500, rarity: "ultra_rare", weight: 0.08, minDepth: 0.8, speed: 0.6, description: "A titanic shadow beast from beyond the abyss. Feared by all ocean life.", baseScale: 2.5 },
