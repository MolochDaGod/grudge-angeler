...
const allFish: Array<{ name: string; img: string; rarity: string; points: number; desc: string; tint?: string; sprite?: { src: string; sheetW: number; frameW: number; frameH: number; frames: number } }> = [
  { name: "Minnow", img: "/assets/gen-icons/fish-minnow.png", rarity: "common", points: 10, desc: "A tiny silver fish, common in shallow waters.", sprite: { src: "/assets/catch/1.png", sheetW: 24, frameW: 6, frameH: 6, frames: 4 } },
  { name: "Perch", img: "/assets/gen-icons/fish-perch.png", rarity: "common", points: 25, desc: "A striped freshwater fish with sharp fins.", sprite: { src: "/assets/catch/2.png", sheetW: 32, frameW: 16, frameH: 12, frames: 2 } },
  { name: "Eel", img: "/assets/gen-icons/fish-eel.png", rarity: "common", points: 40, desc: "A slippery serpentine fish.", sprite: { src: "/assets/catch/7.png", sheetW: 60, frameW: 15, frameH: 12, frames: 4 } },
  ...
  { name: "Bass", img: "/assets/gen-icons/fish-bass.png", rarity: "uncommon", points: 50, desc: "A strong fighter popular with anglers.", sprite: { src: "/assets/catch/3.png", sheetW: 40, frameW: 20, frameH: 12, frames: 2 } },
  { name: "Salmon", img: "/assets/gen-icons/fish-salmon.png", rarity: "uncommon", points: 60, desc: "A prized pink-fleshed fish.", sprite: { src: "/assets/catch/8.png", sheetW: 60, frameW: 15, frameH: 12, frames: 4 } },
  { name: "Catfish", img: "/assets/gen-icons/fish-catfish.png", rarity: "uncommon", points: 75, desc: "A bottom-dweller with long whiskers.", sprite: { src: "/assets/catch/4.png", sheetW: 52, frameW: 13, frameH: 12, frames: 4 } },
  ...
  { name: "Swordfish", img: "/assets/gen-icons/fish-swordfish.png", rarity: "rare", points: 150, desc: "A powerful ocean predator with a sharp bill.", sprite: { src: "/assets/catch/5.png", sheetW: 56, frameW: 28, frameH: 24, frames: 2 } },
  { name: "Shark", img: "/assets/gen-icons/fish-shark.png", rarity: "rare", points: 400, desc: "A fearsome shark prowling the deep waters.", sprite: { src: "/assets/predators/1/Idle.png", sheetW: 384, frameW: 96, frameH: 96, frames: 4 } },
  { name: "Sea Devil", img: "/assets/gen-icons/fish-sea-devil.png", rarity: "rare", points: 600, desc: "A monstrous crab creature from the deep trenches.", sprite: { src: "/assets/predators/3/Idle.png", sheetW: 384, frameW: 96, frameH: 96, frames: 4 } },
  { name: "Whale", img: "/assets/gen-icons/fish-whale.png", rarity: "legendary", points: 300, desc: "The king of the deep. Incredibly rare!", sprite: { src: "/assets/catch/6.png", sheetW: 108, frameW: 27, frameH: 22, frames: 4 } },
  { name: "Kraken", img: "/assets/gen-icons/fish-kraken.png", rarity: "legendary", points: 800, desc: "A massive squid from the abyss, feared by all.", sprite: { src: "/assets/predators/2/Idle.png", sheetW: 384, frameW: 96, frameH: 96, frames: 4 } },
  { name: "Phantom Minnow", img: "/assets/gen-icons/fish-phantom-minnow.png", rarity: "ultra_rare", points: 500, desc: "A ghostly minnow wreathed in spectral flame.", tint: "rgba(0,255,200,0.35)", sprite: { src: "/assets/catch/1.png", sheetW: 24, frameW: 6, frameH: 6, frames: 4 } },
  { name: "Volcanic Perch", img: "/assets/gen-icons/fish-volcanic-perch.png", rarity: "ultra_rare", points: 600, desc: "Scales glow molten orange from deep-sea vents.", tint: "rgba(255,80,0,0.4)", sprite: { src: "/assets/catch/2.png", sheetW: 32, frameW: 16, frameH: 12, frames: 2 } },
  { name: "Abyssal Bass", img: "/assets/gen-icons/fish-abyssal-bass.png", rarity: "ultra_rare", points: 750, desc: "A colossal bass radiating dark energy.", tint: "rgba(120,0,255,0.35)", sprite: { src: "/assets/catch/3.png", sheetW: 40, frameW: 20, frameH: 12, frames: 2 } },
  { name: "Frost Catfish", img: "/assets/gen-icons/fish-frost-catfish.png", rarity: "ultra_rare", points: 800, desc: "Encased in living ice. Freezes the water.", tint: "rgba(100,200,255,0.4)", sprite: { src: "/assets/catch/4.png", sheetW: 52, frameW: 13, frameH: 12, frames: 4 } },
  { name: "Storm Swordfish", img: "/assets/gen-icons/fish-storm-swordfish.png", rarity: "ultra_rare", points: 1000, desc: "Rides lightning bolts with electric fury.", tint: "rgba(255,255,0,0.35)", sprite: { src: "/assets/catch/5.png", sheetW: 56, frameW: 28, frameH: 24, frames: 2 } },
  { name: "Celestial Whale", img: "/assets/gen-icons/fish-celestial-whale.png", rarity: "ultra_rare", points: 2000, desc: "A cosmic whale that swallowed a dying star.", tint: "rgba(255,180,255,0.3)", sprite: { src: "/assets/catch/6.png", sheetW: 108, frameW: 27, frameH: 22, frames: 4 } },
  { name: "Neon Eel", img: "/assets/gen-icons/fish-neon-eel.png", rarity: "ultra_rare", points: 650, desc: "Bioluminescent eel pulsing with neon colors.", tint: "rgba(0,255,100,0.4)", sprite: { src: "/assets/catch/7.png", sheetW: 60, frameW: 15, frameH: 12, frames: 4 } },
  { name: "Golden Salmon", img: "/assets/gen-icons/fish-golden-salmon.png", rarity: "ultra_rare", points: 700, desc: "Solid gold scales. Worth a fortune.", tint: "rgba(255,200,0,0.45)", sprite: { src: "/assets/catch/8.png", sheetW: 60, frameW: 15, frameH: 12, frames: 4 } },
  { name: "Shadow Leviathan", img: "/assets/gen-icons/fish-shadow-leviathan.png", rarity: "ultra_rare", points: 1500, desc: "A titanic shadow beast from beyond the abyss.", tint: "rgba(180,0,50,0.35)", sprite: { src: "/assets/catch/6.png", sheetW: 108, frameW: 27, frameH: 22, frames: 4 } },
];
...
function AnimatedSprite({ sprite, size, tint, className }: {
  sprite: { src: string; sheetW: number; frameW: number; frameH: number; frames: number };
  size: number;
  tint?: string;
  className?: string;
}) {
  const scale = size / sprite.frameW;
  const displayH = sprite.frameH * scale;
  const animName = `sprite-${sprite.src.replace(/[^a-z0-9]/gi, "")}`;
  const totalW = sprite.sheetW * scale;

  return (
    <div style={{ width: size, height: displayH, overflow: "hidden", position: "relative", flexShrink: 0 }} className={className}>
      <style>{`
        @keyframes ${animName} {
          from { transform: translateX(0); }
          to { transform: translateX(-${totalW - size}px); }
        }
      `}</style>
      <img
        src={sprite.src}
        ...
        style={{
          ...
          display: "block",
          animation: `${animName} ${sprite.frames * 0.25}s steps(${sprite.frames - 1}) infinite`,
                      ...
                      {fish.sprite ? (
                        <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                          <AnimatedSprite
                            sprite={fish.sprite}
                            size={42}
                            tint={isUltra ? fish.tint : undefined}
                          />
                        </div>
                      ) : (
