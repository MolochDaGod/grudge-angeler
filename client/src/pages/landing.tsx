...
const allFish: LandingFish[] = [
  ...
  { name: "Electric Eel", rarity: "uncommon", points: 65, desc: "A shocking eel crackling with electric charge.", icon: "/assets/gen-icons/fish-electric-eel.png", sprite: { src: "", frameW: 48, frameH: 48, frames: 6, sheetW: 288, framesDir: "/assets/creatures/5/frames", frameCount: 6 } },
  { name: "Blue Ring Octopus", rarity: "uncommon", points: 55, desc: "A small but deadly octopus with glowing blue rings.", icon: "/assets/gen-icons/fish-blue-octopus.png", sprite: { src: "", frameW: 48, frameH: 48, frames: 6, sheetW: 288, framesDir: "/assets/creatures/6/frames", frameCount: 6 } },
  ...
  { name: "Moray Eel", rarity: "rare", points: 90, desc: "A thick-bodied eel lurking in reef crevices.", icon: "/assets/gen-icons/fish-moray-eel.png", sprite: { src: "", frameW: 48, frameH: 48, frames: 6, sheetW: 288, framesDir: "/assets/creatures/5/frames", frameCount: 6 } },
  ...
  { name: "Deep Sea Angler", rarity: "rare", points: 140, desc: "A pitch-black anglerfish with a sinister yellow glow.", icon: "/assets/gen-icons/fish-deep-angler.png", sprite: { src: "", frameW: 48, frameH: 48, frames: 4, sheetW: 192, framesDir: "/assets/creatures/4/frames", frameCount: 4 } },
